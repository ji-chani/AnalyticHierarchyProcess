...
class Hierarchy:
    ...
    def compute_decision(self) -> np.ndarray:
        ...
        ranking = np.argsort(self.decision_weights)[::-1] + 1 # reversed or descending
...
class Layer(Hierarchy):
    ...
    def update_weights(self, layer_idx:int=None, input_type:str=None, values:list=None, comparison_matrix:np.ndarray=None, reverse:bool=False):
